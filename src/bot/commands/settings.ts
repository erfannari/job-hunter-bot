...
export async function handleSettingsCommand(ctx: CommandContext<Context>) {
  const message = [
    ...
    '• Workplace Language: *English* (Required / OK)',
    '• Excluded: *Russian*, non-English mandatory roles',
    '',
    '📡 *Monitored Job Sources:*',
    '• 🇬🇪 *Jobs.ge* — Active 🟢 (IT Category & keywords)',
    '• 💼 *LinkedIn Jobs (Georgia)* — Active 🟢 (Tbilisi & remote)',
    '• 🚫 *HeadHunter.ge* — Disabled 🔴 (Russian phone requirement)',
    '',
    '🔔 *Alert Thresholds:*',
